...
#SE COMENTO PORQUE SE ROMPIA EL TECLADO EN EL FRONT.
...
def resetear():
    ...
    var_impuestos.set("")
    var_total.set("")
# iniciar tkinter, luego con el . podemos acceder a sus propiedades.
aplicacion = Tk()

# Tamaño de la ventana
#aplicacion.geometry("1080x630+0+0")
aplicacion.geometry("1024x768+0+0")
...
# Color de la ventana
aplicacion.config(background='#ccd5ae')
...
# Etiqueta titulo
etiqueta_titulo = Label(panel_superior, text="Sistema de Facturación", foreground='#e9edc9',
                        font=('Dosis',48),background='#ccd5ae', width=27)
...
# Panel de costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=FLAT, background="azure4", padx=50)
panel_costos.pack(side=BOTTOM)

# Panel comidas
panel_comidas = LabelFrame(panel_izquierdo, text="Comida", font=("Dosis",19,"bold"),
                           bd=1, relief=FLAT, foreground="#ccd5ae")
...
# Panel calculadora
#panel_calculadora = Frame(panel_derecho, bd=1, relief=FLAT, background="#fefae0")
#panel_calculadora.pack()

# Panel recibo
panel_recibo = Frame(panel_derecho, bd=1, relief=FLAT, background="#fefae0")
panel_recibo.pack()

# Panel botones
panel_botones = Frame(panel_derecho, bd=1, relief=FLAT, background="#fefae0")
panel_botones.pack()

# Lista de productos
lista_comidas = ["pollo", "cordero", "salmon", "merluza", "kebab", "pizza1","pizza2","pizza3"]
lista_bebidas = ["agua","jugo","cola","vino1","vino2","cerveza1","cerveza2","cerveza3"]
lista_postres = ["helado","fruta","flan","brownie","mousse","pastel1","pastel2","pastel3"]
